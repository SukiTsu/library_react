      ...
      <div className="body-input">
        ...
        <div className="body-input-presentation">
          <div className="body-input-header">
            <h1>{RESUME_DATA.content.atoms.component5.name}</h1>
            <h3>{RESUME_DATA.content.atoms.component5.description}</h3>
          </div>
          <div className="body-input-text">
            <h2>{RESUME_DATA.content.atoms.component5.presentation.title}</h2>
            <p>
